...
class DashController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($cup_volume >= $drink_volume) {
            ...
            return back()->with('message', "Your choice is too big for the selected cup. Cup volume: " . $cup_volume . ' drink volume: ' . $drink_volume . $request->input('my_percentage_slider') .'.');
        }
    }
}
