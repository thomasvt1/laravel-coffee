                    ...
                    <div class="card-body ">
                        @foreach ($preferences as $preference)   
                            <!--<p>{{ $preference}}</p>-->
                             ...
                             Cup: {{$cups->firstWhere('id', $preference->cup_id)->name}} preference drink: {{$drinks->firstWhere('id', $preference->drink_id)->name}} {{(json_decode(($preference->data)->data,true))['strength']}} <br><br> 
                        @endforeach
